...
const Footer = () => {
  return (
    <footer className="footer footer-center p-10 bg-slate-200 text-black w-screen flex flex-wrap justify-between items-center gap-2">
      <aside>
        <Image
          src={"/ghanendra.jpg"}
          width={100}
      ...
      <div className="text-lg font-semibold ">
        <p>Email address:</p>
        <p>ghanendrapurushdhakal@gmail.com</p>
