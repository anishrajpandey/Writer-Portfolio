      ...
      <main className="grid grid-cols-1 md:grid-cols-2 px-4 md:px-12 min-h-[300px]  py-4 gap-2 justify-center items-center">
        ...
        <div className="flex flex-col justify-center items-center">
          <div className="info py-4 px-2">
            <h2 className="text-lg font-semibold text-orange-secondary">
            ...
            <p className="text-sm  md:text-md text-faded">
              ...
              aliquam placeat ipsam, doloremque unde quidem? laborum repudiandae
              quaerat. Totam beatae, voluptas nobis, natus nesciunt
              reprehenderit incidunt repudiandae quos temporibus aliquam placeat
              ipsam, doloremque unde quidem? laborum repudiandae quaerat. Totam
              beatae, voluptas nobis, natus nesciunt reprehenderit incidunt
